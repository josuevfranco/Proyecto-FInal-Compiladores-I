...
namespace ProyectoFinalCompiladoresI_ISCUAA
{
    public class T_SimbolosM
    {
        ...
        public void Tokens()
        {
            ...
            tSimbolos.Add(tk6);
            Constructor_Tsimbolos tk7 = new Constructor_Tsimbolos(7, "float", "Palabra reservada", " Numero con decimales ");
            tSimbolos.Add(tk7);
            Constructor_Tsimbolos tk8 = new Constructor_Tsimbolos(8, "string", "Palabra reservada", " Cadena de caracteres ");
            tSimbolos.Add(tk8);
            Constructor_Tsimbolos tk9 = new Constructor_Tsimbolos(9, "bool", "Palabra reservada", " Booleano true or false ");
            tSimbolos.Add(tk9);
            ...
            tSimbolos.Add(tk28);
            Constructor_Tsimbolos tk29 = new Constructor_Tsimbolos(29, "else", "Palabra reservada", " si tal condicion no se cumple ");
            tSimbolos.Add(tk29);
